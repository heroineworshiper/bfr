...
const STATE_LIFTOFF1 = 7
const STATE_LIFTOFF2 = 8
const STATE_PLAYBACK = 9

var state = STATE_INIT1
var starting_time = 0
...
# initialize game stuff
    ...
    Globals.player.rigid.sleeping = false
...
func follow_player():
    library.player_cam.translation = Globals.player.rigid.global_transform.origin + \
        Vector3(0, -200, 50)
