...
var samples = [
    preload('res://sounds/engine_start.wav'),
    preload('res://sounds/engine_loop1.wav'),
    preload('res://sounds/engine_transition1.wav'),
    preload('res://sounds/engine_loop2.wav'),
    preload('res://sounds/engine_transition2.wav'),
    preload('res://sounds/engine_loop3.wav'),
    preload('res://sounds/engine_transition3.wav')
]
